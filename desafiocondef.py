    ...
    try:
        with open(nombre_archivo, "r", encoding="utf-8") as archivo:
            ...
            for linea in archivo:
                ...
                if local == visitante:
                    print("    No valido, un equipo no puede jugar contra si mismo.")
                    return {}
                ...
                if equipos[local]["pj"] >= 3 or equipos[visitante]["pj"] >= 3:
                    print("    No valido, un equipo no puede jugar mas de 3 partidos.")
                    return {}
...
if not equipos or any(stats["pj"] != 3 for _, stats in equipos.items()):
    print("  Error: porfavor ingrese datos validos, tenga en cuenta que un pais no puede jugar mas de 3 partidos")
else:
